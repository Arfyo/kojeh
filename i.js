...
menu =`ROBOTZ`// sini ubh aja jdi nama lu
let mhan = await denz.prepareMessage("0@s.whtsapp.net", fs.readFileSync('./denz.jpg'), image)
gbutsan = [{buttonId: `${prefix}allmenu`, buttonText: {displayText: 'LIST MENU'}, type: 1},{buttonId: `${prefix}owner`, buttonText: {displayText: 'OWNER'}, type: 1},{buttonId: `${prefix}sc`, buttonText: {displayText: 'SCRIPT'}, type: 1}]
gbuttonan = {
imageMessage: mhan.message.imageMessage,
    
contentText: `${fill}`,// ini buat nampilin menunya
...
// yg di ubh yg atass
await denz.sendMessage(from, gbuttonan, MessageType.buttonsMessage,{sendEphemeral: true, contextInfo: {forwardingScore: 508, isForwarded: true, "externalAdReply": { "title": `Hallo ${pushname}`, "body": `${tampilUcapan}`, "mediaType": "2", "thumbnail": "ofrply", "mediaUrl": "https://youtu.be/uygjD8rqVLE", "thumbnail": ofrply, "sourceUrl": "",},mentionedJid:[otod]}, quoted : ftrol})
} 
...
- Hari : ${week} ${weton}
- Tanggal : ${calender}`
sendButLocation(from, `${menu}`, "A W A N G", {jpegThumbnail:gambar,name:""}, [
...
└─────────────────❒`
sendButLocation(from, `${menu}`, "ROBOTZ den", {jpegThumbnail:gambar,name:""}, [{buttonId:`owner`,buttonText:{displayText:'👑OWNER'},type:1},{buttonId:`script`,buttonText:{displayText:'📒SCRIPT'},type:1}], {contextInfo: { mentionedJid: [otod]}})
break
case 'command':
 stod = `${sender}`
 listMsg = {
...
Giliran = @${tty.player1.split('@')[0]}`
 denz.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
     ...
     denz.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer REN BOT",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"https://wa.me/62895410396931?text=Assalamualaikum"}}})
	}
    }
    }
    }
